...
include('../db_connection/db_connection.php');
    ...
    if(isset($_GET['id']) AND isset($_GET['image_name'])){
        ...
        if($image_name != ""){
            ...
            $path= "../b-images/post-images/".$image_name;
            ...
            if($remove==FALSE){
                ...
                $_SESSION['remove-post'] = "<div class='error'>Failed to remove the image.</div>";
        ...
        //2. create sql to delete the admin
            ...
            if($res==TRUE){
                ...
                $_SESSION['delete-post'] = "<div class='success'> Post deleted successfully.</div>";
                ...
                $_SESSION['delete-post'] = "<div class='error'> Failed to delete the post.</div>";
